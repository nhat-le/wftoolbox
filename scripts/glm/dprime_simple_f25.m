...
files = dir(sprintf('%s/templateData/f25/*.mat', root));
...
%     nfr = 29;
    ...
    for j = 1:numel(template.areaid)
        ...
        agg_corr_master(areaid, 1:nfr,currdim_corr + 1 : currdim_corr + Ncorr) = ...
            agg_corr(j,:,:);
        agg_incorr_master(areaid, 1:nfr,currdim_incorr + 1 : currdim_incorr + Nincorr) = ...
            agg_incorr(j,:,:);
    end
%     
%     
